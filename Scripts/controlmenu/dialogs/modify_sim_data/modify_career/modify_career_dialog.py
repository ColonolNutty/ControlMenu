...
from controlmenu.dialogs.modify_sim_data.modify_career.set_career.operations.remove_career import CMRemoveCareerSimOp
from controlmenu.dialogs.modify_sim_data.modify_career.set_career.operations.set_career import CMSetCareerSimOp
        ...
        **__
        ...
        option_dialog.add_option(
            CommonDialogButtonOption(
                ...
                on_chosen=lambda *_, **__: _operation_run(CMRemoveCareerSimOp())
            )
        )
        return True
