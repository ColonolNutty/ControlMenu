...
class CMRemoveTraitsSimOp(CMSingleSimOperation):
    """Remove Traits from a Sim."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_remove_traits_sim'
                ...
                option_dialog.add_option(
                    CommonDialogSelectOption(
                        ...
                        CommonDialogOptionContext(
                            ...
                            description,
                            icon=icon,
                            is_enabled=self.is_trait_allowed_for_removal(trait)
                        ),
    ...
    def is_trait_allowed_for_removal(self, trait: Trait) -> bool:
        """is_trait_allowed_for_removal(trait)
