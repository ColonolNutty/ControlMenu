...
from controlmenu.dialogs.modify_sim_data.modify_lifestyles.operations.set_lifestyles_values import \
    CMSetLifestyleValuesSimOp
...
class CMModifyLifestylesDialog(CMSimControlDialogBase):
    """ The control dialog for Sims. """

    # noinspection PyMissingOrEmptyDocstring
    @classmethod
    def get_log_identifier(cls) -> str:
        return 'cm_modify_lifestyles_dialog'
        ...
        **__
        ...
        option_dialog.add_option(
            CommonDialogButtonOption(
                ...
                on_chosen=lambda *_, **__: _operation_run(CMSetLifestyleValuesSimOp())
            )
        )
        return True
