...
class CMSimModifySkillsStringId(CommonInt):
    ...
    ENTER_A_VALUE_BETWEEN_MIN_AND_MAX_FOR_SKILL = 0xE8FED0B1
    ...
    RANDOMIZE_SELECT_SKILL_LEVELS_TITLE = 0x13D9E038
    UNSELECT_SKILLS_YOU_DO_NOT_WANT_RANDOMIZED = 0xC010C9C8
    ARE_YOU_SURE_YOU_WANT_TO_RANDOMIZE_SELECTED_SKILLS_FOR_SIM = 0x4FA8183E
