...
class CMRemoveAllSkillsSimOp(CMSingleSimOperation):
    """Remove All Skills from a Sim."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_remove_all_skills_of_sim'
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        def _on_yes_selected(_: Any):
            ...
            CommonBasicNotification(
                CMSimModifySkillsStringId.REMOVED_ALL_SKILLS_TITLE,
                CMSimModifySkillsStringId.REMOVED_ALL_SKILLS_DESCRIPTION,
                title_tokens=(sim,),
        ...
        confirmation = CommonOkCancelDialog(
            ...
            CMSimModifySkillsStringId.ARE_YOU_SURE_YOU_WANT_TO_REMOVE_ALL_SKILLS_FROM_SIM,
