...
class CMRandomizeAllSkillsSimOp(CMSingleSimOperation):
    """Set All Skills of a Sim to a random level."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_set_all_skills_random_for_sim'
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        confirmation = CommonOkCancelDialog(
            ...
            CMSimModifySkillsStringId.ARE_YOU_SURE_YOU_WANT_TO_RANDOMIZE_ALL_SKILLS_FOR_SIM,
