...
class CMMaxAllSkillsSimOp(CMSingleSimOperation):
    """Set All Skills of a Sim to their Maximum level."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_set_all_skills_max_for_sim'
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        def _on_yes_selected(_: Any):
            ...
            CommonBasicNotification(
                CMSimModifySkillsStringId.MAXED_ALL_SKILLS_TITLE,
                CMSimModifySkillsStringId.MAXED_ALL_SKILLS_DESCRIPTION,
                title_tokens=(sim,),
        ...
        confirmation = CommonOkCancelDialog(
            ...
            CMSimModifySkillsStringId.ARE_YOU_SURE_YOU_WANT_TO_MAX_ALL_SKILLS_FOR_SIM,
