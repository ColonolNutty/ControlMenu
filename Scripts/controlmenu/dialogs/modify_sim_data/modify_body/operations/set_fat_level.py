...
class CMSetFatLevelOp(CMSingleSimOperation):
    """Set the Fat level of a Sim."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_set_fat_level'
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        current_level = CommonSimBodyUtils.get_fat_level(sim_info)
        ...
        dialog = CommonInputFloatDialog(
            ...
            CommonLocalizationUtils.combine_localized_strings(
                (
                    CMSimControlMenuStringId.WHAT_LEVEL_OF_FAT_DESCRIPTION,
