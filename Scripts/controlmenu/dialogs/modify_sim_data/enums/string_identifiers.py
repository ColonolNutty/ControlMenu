...
class CMSimControlMenuStringId(CommonInt):
    ...
    # Tokens: {0.SimFirstName} (Sim A) {1.SimFirstName} (Sim B)
    SET_SIM_A_ROMANTIC_SATISFACTION_LEVEL_TOWARD_SIM_B = 0x95C4555C
    # Tokens: {0.SimFirstName} (Sim A)
    SET_SIM_A_ROMANTIC_SATISFACTION_LEVEL_TOWARD_A_SIM = 0x0E385C83
    # Tokens: {0.SimFirstName} (Sim A)
    SET_A_SIMS_ROMANTIC_SATISFACTION_LEVEL_TOWARD_SIM_A = 0x7C539E7A
