...
class CMAddHasMetSimsOp(CMSingleSimOperation):
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        dialog = CommonPremadeChooseSimsOptionDialog(
            ...
            CMSimControlMenuStringId.CHOOSE_SIMS_TO_ADD_HAS_MET,
...
class CMRemoveHasMetSimsOp(CMSingleSimOperation):
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        dialog = CommonPremadeChooseSimsOptionDialog(
            ...
            CMSimControlMenuStringId.CHOOSE_SIMS_TO_REMOVE_HAS_MET,
            include_sim_callback=_has_relationship,
            description_tokens=(sim_info,),
            instanced_sims_only=False,
            mod_identity=self.mod_identity
