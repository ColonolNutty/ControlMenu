...
class CMSetSimAAsMotherToSimBOp(CMSetSimAAsRelationToSimBOperation):
    """Set Sim A as a mother of Sim B"""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 'cm_set_mother'
    ...
    def _display_name(self) -> int:
        return CMSimControlMenuStringId.MOTHER
    ...
    def _update_family_tree(self, parent_sim_info: SimInfo, child_sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        try:
            ...
            CommonSimGenealogyUtils.set_as_mother_of(parent_sim_info, child_sim_info)
            # if CommonSimGenealogyUtils.has_mother(child_sim_info):
            #     previous_parent_sim_info = CommonSimGenealogyUtils.get_mother_sim_info(child_sim_info)
