...
class CMSetSimAAsAuntOrUncleToSimBOp(CMSetSimAAsRelationToSimBOperation):
    ...
    def _remove_old_relation(self, sim_info: SimInfo) -> bool:
        ...
        for sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(sim_info):
        ...
        for blood_family_sim_info in old_blood_family_sim_info_list_temp:
            for blood_niece_nephew_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(blood_family_sim_info):
        ...
        for blood_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(sim_info):
        ...
        for old_blood_family_sim_info in old_blood_family_sim_info_list:
            ...
            for alternate_parent_sim_info in alternate_parent_sim_info_list:
                ...
                for alt_parent_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(alternate_parent_sim_info):
                ...
                for alt_parent_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(alternate_parent_sim_info):
                ...
                for alt_parent_grandparent_sim_info in CommonSimGenealogyUtils.get_grandparent_sim_info_gen(alternate_parent_sim_info):
                ...
                for alt_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(alternate_parent_sim_info):
                ...
                for alt_parent_sibling_sim_info in alt_parent_siblings_sim_info_list:
                    for alt_parent_sibling_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(alt_parent_sibling_sim_info):
        ...
        for old_blood_sibling_sim_info in old_blood_siblings_sim_info_list:
            for blood_siblings_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(old_blood_sibling_sim_info):
        ...
        for old_blood_alt_parent_sibling_sim_info in old_alternate_blood_sibling_parent_sim_info_list:
            ...
            for alt_parent_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(old_blood_alt_parent_sibling_sim_info):
            ...
            for alt_parent_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(old_blood_alt_parent_sibling_sim_info):
                if alt_parent_sibling_sim_info in alt_parent_siblings_sim_info_list:
                    continue
            ...
            for alt_parent_grandparent_sim_info in CommonSimGenealogyUtils.get_grandparent_sim_info_gen(old_blood_alt_parent_sibling_sim_info):
            ...
            for alt_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(old_blood_alt_parent_sibling_sim_info):
    ...
    def _add_new_relation(self, aunt_or_uncle_sim_info: SimInfo, nephew_or_niece_sim_info: SimInfo, parent_of_nephew_or_niece_sim_info: SimInfo, other_parent_of_nephew_or_niece_sim_info: SimInfo) -> bool:
        ...
        for new_nephew_or_niece_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(parent_of_nephew_or_niece_sim_info):
        ...
        for new_brother_or_sister_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(parent_of_nephew_or_niece_sim_info):
        ...
        for new_brother_or_sister_sim_info in new_brother_or_sister_sim_info_list:
            for new_nephew_or_niece_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_brother_or_sister_sim_info):
                new_niece_nephew_sim_info_list.append(new_nephew_or_niece_sim_info)
                self.log.format_with_message('Found niece/nephew. Adding them.', sim=aunt_or_uncle_sim_info, niece_nephew=new_nephew_or_niece_sim_info)
                CommonRelationshipUtils.add_relationship_bit(new_nephew_or_niece_sim_info, aunt_or_uncle_sim_info, CommonRelationshipBitId.FAMILY_AUNT_UNCLE)
                CommonRelationshipUtils.add_relationship_bit(aunt_or_uncle_sim_info, new_nephew_or_niece_sim_info, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW)
            ...
            for new_nephew_or_niece_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(aunt_or_uncle_sim_info):
        ...
        for new_nephew_or_niece_sim_info in new_niece_nephew_sim_info_list:
            ...
            for new_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(aunt_or_uncle_sim_info):
        ...
        if CommonSimGenealogyUtils.has_father(parent_of_nephew_or_niece_sim_info):
            ...
            for new_grandchild_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(aunt_or_uncle_sim_info):
        ...
        for new_grandparent_sim_info in CommonRelationshipUtils.get_sim_info_of_all_sims_with_relationship_bit_generator(parent_of_nephew_or_niece_sim_info, CommonRelationshipBitId.FAMILY_PARENT, instanced_only=False):
            ...
            for child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(aunt_or_uncle_sim_info):
