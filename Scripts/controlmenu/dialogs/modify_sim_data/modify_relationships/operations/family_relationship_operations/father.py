...
class CMSetSimAAsFatherToSimBOp(CMSetSimAAsRelationToSimBOperation):
    ...
    def _update_family_tree(self, parent_sim_info: SimInfo, child_sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        try:
            ...
            CommonSimGenealogyUtils.set_as_father_of(parent_sim_info, child_sim_info)
    ...
    #     for previous_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_parent_sim_info):
    ...
    #     for previous_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(previous_parent_sim_info):
    ...
    #         for previous_parent_blood_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_parent_blood_siblings_sim_info):
    ...
    #     for previous_other_parent_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(previous_parent_sim_info):
    ...
    #         for previous_other_parent_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(previous_other_parent_sim_info):
    ...
    #         for previous_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_other_parent_sim_info):
    ...
    #         for previous_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(previous_other_parent_sim_info):
    ...
    #
    #             for previous_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_other_parent_sim_info):
    ...
    #
    #         for previous_parent_remove_blood_grandchildren in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_parent_remove_blood_children_sim_info):
    ...
    #         for previous_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(previous_parent_alternate_parent_sim_info):
    ...
    #             for previous_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_parent_alternate_parent_siblings_sim_info):
    #                 for previous_parent_remove_blood_children_sim_info in previous_parent_remove_blood_children_sim_info_list:
    ...
    #         for previous_other_parent_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(previous_parent_alternate_parent_sim_info):
    ...
    #         for previous_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(previous_parent_alternate_cousin_parent_sim_info):
    ...
    #             for previous_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(previous_parent_alternate_cousin_parent_siblings_sim_info):
    #                 for previous_parent_remove_blood_children_sim_info in previous_parent_remove_blood_children_sim_info_list:
    #                     CommonRelationshipUtils.remove_relationship_bit(previous_cousin_sim_info, previous_parent_remove_blood_children_sim_info, CommonRelationshipBitId.FAMILY_COUSIN)
    #                     CommonRelationshipUtils.remove_relationship_bit(previous_parent_remove_blood_children_sim_info, previous_cousin_sim_info, CommonRelationshipBitId.FAMILY_COUSIN)
    #
    #         previous_parent_alternate_cousin_parent_parent_sim_info_list = list()
    #         for previous_other_parent_parent_parent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(previous_parent_alternate_cousin_parent_sim_info):
    ...
    #     for new_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(new_parent_sim_info):
    ...
    #     for new_child_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_parent_sim_info):
    ...
    #         for new_sibling_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(new_parent_alternate_parent_sim_info):
    ...
    #
    #         for new_step_sibling_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_parent_alternate_parent_sim_info):
    ...
    #
    #         for new_grandparent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(new_parent_alternate_parent_sim_info):
    ...
    #         for new_step_sibling_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_parent_alternate_parent_siblings_sim_info):
    ...
    #         for new_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_parent_blood_siblings_sim_info):
    ...
    #         for new_cousin_sim_info in CommonSimGenealogyUtils.get_children_sim_info_gen(new_parent_alternate_cousin_parent_sim_info):
    ...
    #         for new_uncle_aunt_sim_info in CommonSimGenealogyUtils.get_siblings_sim_info_gen(new_parent_alternate_cousin_parent_sim_info):
    ...
    #         for new_grandparent_sim_info in CommonSimGenealogyUtils.get_parent_sim_info_gen(new_parent_alternate_cousin_parent_sim_info):
