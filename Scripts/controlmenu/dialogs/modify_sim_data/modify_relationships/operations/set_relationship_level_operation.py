...
class CMSetRelationshipLevelOp(CMSingleSimOperation):
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        dialog = CommonPremadeChooseSimOptionDialog(
            CMSimControlMenuStringId.SET_RELATIONSHIP_WITH_WHO,
            0,
    ...
    def run_with_sims(self, sim_info_a: SimInfo, sim_info_b: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop):
        ...
        def _on_bit_chosen(_: Any, chosen_option: CMRelationshipOption):
        ...
        option_dialog = CommonChooseButtonOptionDialog(
            ...
            CMSimControlMenuStringId.CHOOSE_LEVEL,
            0,
