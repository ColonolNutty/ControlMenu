...
from controlmenu.dialogs.modify_sim_data.modify_buffs.operations.remove_buffs import CMRemoveBuffsSimOp
from controlmenu.dialogs.sim_control_dialog_base import CMSimControlDialogBase
from controlmenu.dialogs.modify_sim_data.single_sim_operation import CMSingleSimOperation


class CMModifyBuffsDialog(CMSimControlDialogBase):
    """ The control dialog for Sims. """

    # noinspection PyMissingOrEmptyDocstring
    @classmethod
    def get_log_identifier(cls) -> str:
        return 'cm_modify_buffs_dialog'
    ...
    def _setup_dialog(
        ...
        **__
        ...
        if CMRemoveBuffsSimOp().can_run_with_sim(self._sim_info):
            option_dialog.add_option(
                CommonDialogButtonOption(
                    ...
                    on_chosen=lambda *_, **__: _operation_run(CMRemoveBuffsSimOp())
                )
            )
        return True
