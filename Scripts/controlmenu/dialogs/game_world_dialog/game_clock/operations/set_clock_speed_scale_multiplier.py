...
class CMSetClockSpeedScaleMultiplierOp:
    ...
    def run(self, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        CommonDialogInputFloatOption(
            ...
            CommonDialogOptionContext(
                ...
                description_tokens=(
                    CMGameWorldControlMenuStringId.SET_CLOCK_SPEED_SCALE_DESCRIPTION,
            ...
            min_value=CMSetClockSpeedScaleMultiplierOp._DEFAULT_CLOCK_SPEED_SCALE_MULTIPLIER_MIN,
            max_value=CMSetClockSpeedScaleMultiplierOp._DEFAULT_CLOCK_SPEED_SCALE_MULTIPLIER_MAX,
