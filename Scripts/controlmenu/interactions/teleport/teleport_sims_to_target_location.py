...
class CMTeleportSimsToTargetLocationInteraction(CommonImmediateSuperInteraction):
    """CMTeleportSimsToTargetLocationInteraction(*_, **__)

    Open a dialog and Teleport the selected Sims to the target location.
    """
    ...
    def get_log_identifier(cls) -> str:
        return 'cm_teleport_sims_to_target_location'
    ...
    def on_test(cls, interaction_sim: Sim, interaction_target: Any, interaction_context: InteractionContext, **kwargs) -> TestResult:
        ...
        if location is None:
            ...
            return TestResult.NONE
        cls.get_log().debug('Success, can teleport sims to target location.')
    ...
    def on_started(self, interaction_sim: Sim, interaction_target: Any) -> bool:
        ...
        def _on_submit(chosen_sim_info_list: Tuple[SimInfo]) -> None:
            ...
            for chosen_sim_info in chosen_sim_info_list:
                ...
                try:
                    CommonSimSpawnUtils.hard_reset(chosen_sim_info, ResetReason.RESET_EXPECTED, source=interaction_sim, cause='CM: Teleporting Sim')
                    CommonSimLocationUtils.set_location(chosen_sim_info, target_location)
                except:
                    pass

        dialog = CommonPremadeChooseSimsOptionDialog(
            CMStringId.CHOOSE_SIMS_TO_TELEPORT,
            0,
