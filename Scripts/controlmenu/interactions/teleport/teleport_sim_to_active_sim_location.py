...
class CMTeleportSimToActiveSimLocationInteraction(CommonImmediateSuperInteraction):
    """CMTeleportSimToActiveSimLocationInteraction(*_, **__)
    ...
    def get_log_identifier(cls) -> str:
        return 'cm_teleport_sim_to_active_sim_location'
