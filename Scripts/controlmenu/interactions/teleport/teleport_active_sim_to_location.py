...
class CMTeleportActiveSimToLocationInteraction(CommonImmediateSuperInteraction):
    """CMTeleportActiveSimToLocationInteraction(*_, **__)
    ...
    def get_log_identifier(cls) -> str:
        return 'cm_teleport_active_sim_to_location'
    ...
    def on_started(self, interaction_sim: Sim, interaction_target: Any) -> bool:
        ...
        location = CommonObjectLocationUtils.get_location(interaction_target)
        CommonSimSpawnUtils.hard_reset(sim_info, ResetReason.RESET_EXPECTED, source=interaction_sim, cause='CM: Teleporting Sim')
