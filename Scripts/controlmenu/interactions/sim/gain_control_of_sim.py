...
class CMDebugGainControlOfSimInteraction(CommonImmediateSuperInteraction):
    """ Handles the Gain Control of Sim interaction. """
    ...
    def get_log_identifier(cls) -> str:
        return 'cm_debug_gain_control_of_sim'
    ...
    def on_test(cls, interaction_sim: Sim, interaction_target: Any, interaction_context: InteractionContext, **kwargs) -> CommonTestResult:
        ...
        if target_sim_info in client.selectable_sims:
            cls.get_log().format_with_message('Failed, Target Sim is already selectable.', target_sim=target_sim_info)
            return CommonTestResult.NONE
    ...
    def on_started(self, interaction_sim: Sim, interaction_target: Sim) -> bool:
        ...
        client.add_selectable_sim_info(target_sim_info, send_relationship_update=True)
        return True
