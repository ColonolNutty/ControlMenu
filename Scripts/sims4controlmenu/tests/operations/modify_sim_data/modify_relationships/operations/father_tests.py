...
class _S4CMSetSimAAsFatherToSimBOpTests:
    @staticmethod
    ...
    def _has_relation_sim_a_is_father_of_sim_b() -> None:
        ...
        try:
            ...
            CommonAssertionUtils.is_true(S4CMSetSimAAsFatherToSimBOp().has_relation(sim_info_a, sim_info_b), 'Failed, Sim A should have been the father of Sim B but was not.')
    ...
    def _has_relation_sim_a_is_not_father_of_sim_b() -> None:
        ...
        sim_info_b: SimInfo = CommonSimSpawnUtils.create_human_sim_info()
        try:
            CommonAssertionUtils.is_false(S4CMSetSimAAsFatherToSimBOp().has_relation(sim_info_a, sim_info_b), 'Failed, Sim A should not have been the father of Sim B but was.')
        except Exception as ex:
            raise ex
        finally:
            CommonSimSpawnUtils.delete_sim(sim_info_a, cause='S4CM: testing cleanup')
    ...
    def _has_relation_sim_a_is_only_rel_bit_father_of_sim_b() -> None:
        ...
        try:
            ...
            CommonAssertionUtils.is_false(S4CMSetSimAAsFatherToSimBOp().has_relation(sim_info_a, sim_info_b), 'Failed, Sim A should not have been the father of Sim B with only the relationship bit but was.')
        except Exception as ex:
            raise ex
        finally:
            CommonSimSpawnUtils.delete_sim(sim_info_a, cause='S4CM: testing cleanup')
    ...
    def _has_relation_sim_a_is_only_family_tree_father_of_sim_b() -> None:
        ...
        try:
            ...
            CommonAssertionUtils.is_false(S4CMSetSimAAsFatherToSimBOp().has_relation(sim_info_a, sim_info_b), 'Failed, Sim A should not have been the father of Sim B with only the family tree but was.')
        except Exception as ex:
            raise ex
        finally:
            CommonSimSpawnUtils.delete_sim(sim_info_a, cause='S4CM: testing cleanup')
    ...
    def _setting_sim_a_as_father_to_sim_b_should_change_grandmother_from_sim_d_to_sim_e() -> None:
        ...
        try:
            ...
            grandmother_sim_info_b = CommonSimGenealogyUtils.get_sim_info_of_grandmother_of_sim_on_fathers_side(sim_info_b)
    ...
    def _setting_sim_a_as_father_to_sim_b_should_change_grandfather_from_sim_d_to_sim_e() -> None:
        ...
        try:
            ...
            grandfather_sim_info_b = CommonSimGenealogyUtils.get_sim_info_of_grandfather_of_sim_on_fathers_side(sim_info_b)
    ...
    def _setting_sim_a_as_father_to_sim_b_should_set_new_father_as_grandfather_of_children_of_sim_b() -> None:
        ...
        try:
            ...
            grandfather_sim_info_d = CommonSimGenealogyUtils.get_sim_info_of_grandfather_of_sim_on_mothers_side(sim_info_d)
