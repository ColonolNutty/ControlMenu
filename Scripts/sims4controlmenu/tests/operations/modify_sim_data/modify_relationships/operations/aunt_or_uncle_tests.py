...
class _S4CMSetSimAAsAuntOrUncleToSimBOpTests:
    ...
    def _setting_sim_a_as_uncle_to_sim_b_should_remove_relationships_from_old_family() -> None:
        ...
        try:
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_three, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was still a grandchild to Grandfather Three')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_four, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was still a grandchild to Grandfather Four')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was still a grandchild to Grandfather One')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_three, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was still a grandchild to Grandfather Three')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_four, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was still a grandchild to Grandfather Four')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandfather_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was still a grandchild to Grandfather One')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandmother_three, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was still a grandchild to Grandmother Three')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandmother_four, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was still a grandchild to Grandmother Four')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandmother_three, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was still a grandchild to Grandmother Three')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.grandmother_four, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was still a grandchild to Grandmother Four')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.mother_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Mother One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.mother_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Mother One')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.mother_two, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Mother Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.mother_two, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Mother Two')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_five, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Uncle Five')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_five, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Uncle Five')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_six, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Uncle Six')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_six, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Uncle Six')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_seven, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Uncle Seven')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_seven, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Uncle Seven')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_eight, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was still a nephew to Uncle Eight')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.uncle_eight, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was still a nephew to Uncle Eight')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_BROTHER_SISTER), 'Cousin One was no longer a sibling of Cousin Two')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.grandfather_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Three was still a grandparent of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.grandfather_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Four was still a grandparent of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.grandmother_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Three was still a grandparent of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.grandmother_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Four was still a grandparent of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.mother_one, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother One was still an aunt of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.mother_two, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother Two was still an aunt of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.uncle_five, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Five was still an uncle of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.uncle_six, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Six was still an uncle of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.uncle_seven, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Seven was still an uncle of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, old_full_family.uncle_eight, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Eight was still an uncle of Cousin One')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_BROTHER_SISTER), 'Cousin Two was no longer a sibling of Cousin One')
            ...
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.grandfather_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Three was still a grandparent of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.grandfather_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Four was still a grandparent of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.grandmother_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Three was still a grandparent of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.grandmother_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Four was still a grandparent of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.mother_one, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother One was still an aunt of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.mother_two, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother Two was still an aunt of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.uncle_five, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Five was still an uncle of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.uncle_six, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Six was still an uncle of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.uncle_seven, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Seven was still an uncle of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, old_full_family.uncle_eight, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Eight was still an uncle of Cousin Two')
            ...
            # Cousin 9
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_nine, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Nine was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_nine, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Nine was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_nine, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Nine')

            # Cousin 10
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_ten, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Ten was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_ten, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Ten was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_ten, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Ten')

            # Cousin 11
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_eleven, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Eleven was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_eleven, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Eleven was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_eleven, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Eleven')

            # Cousin 12
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_twelve, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Twelve was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_twelve, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Twelve was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_twelve, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Twelve')

            # Cousin 13
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_thirteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Thirteen was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_thirteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Thirteen was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_thirteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Thirteen')

            # Cousin 14
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fourteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fourteen was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fourteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fourteen was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fourteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Fourteen')

            # Cousin 15
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fifteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fifteen was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fifteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fifteen was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_fifteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Fifteen')

            # Cousin 16
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_sixteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Sixteen was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_sixteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Sixteen was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_sixteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Cousin Sixteen')
            ...
            # Step Child 1
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.step_child_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Step Child One was still a cousin of Cousin One')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.step_child_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Step Child One was still a cousin of Cousin Two')
            CommonAssertionUtils.is_false(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.step_child_one, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was still an uncle to Step Child One')
    ...
    def _setting_sim_a_as_uncle_to_sim_b_should_add_relationships_from_new_family() -> None:
        ...
        try:
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_three, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was not a grandchild to Grandfather Three')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_four, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was not a grandchild to Grandfather Four')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was not a grandchild to Grandfather One')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_three, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was not a grandchild to Grandfather Three')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_four, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was not a grandchild to Grandfather Four')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandfather_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was not a grandchild to Grandfather One')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandmother_three, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was not a grandchild to Grandmother Three')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandmother_four, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin One was not a grandchild to Grandmother Four')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandmother_three, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was not a grandchild to Grandmother Three')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.grandmother_four, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_GRANDCHILD), 'Cousin Two was not a grandchild to Grandmother Four')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.mother_one, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Mother One was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.mother_two, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Mother Two was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.uncle_five, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Uncle Five was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.uncle_six, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Uncle Six was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.uncle_seven, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Uncle Seven was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, new_full_family.uncle_eight, CommonRelationshipBitId.FAMILY_STEP_SIBLING), 'Uncle Eight was not a sibling to Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_SON_DAUGHTER), 'Cousin One was no longer a child of Sim A')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(sim_a_uncle, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_SON_DAUGHTER), 'Cousin Two was no longer a child of Sim A')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.mother_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Mother One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.mother_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Mother One')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.mother_two, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Mother Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.mother_two, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Mother Two')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_five, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Uncle Five')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_five, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Uncle Five')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_six, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Uncle Six')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_six, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Uncle Six')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_seven, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Uncle Seven')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_seven, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Uncle Seven')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_eight, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin One was not a nephew to Uncle Eight')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.uncle_eight, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_NIECE_NEPHEW), 'Cousin Two was not a nephew to Uncle Eight')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.grandfather_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Three was not a grandparent of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.grandfather_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Four was not a grandparent of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.grandmother_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Three was not a grandparent of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.grandmother_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Four was not a grandparent of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.mother_one, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother One was not an aunt of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.mother_two, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother Two was not an aunt of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.uncle_five, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Five was not an uncle of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.uncle_six, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Six was not an uncle of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.uncle_seven, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Seven was not an uncle of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_one, new_full_family.uncle_eight, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Eight was not an uncle of Cousin One')
            ...
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.grandfather_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Three was not a grandparent of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.grandfather_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandfather Four was not a grandparent of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.grandmother_three, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Three was not a grandparent of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.grandmother_four, CommonRelationshipBitId.FAMILY_GRANDPARENT), 'Grandmother Four was not a grandparent of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.mother_one, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother One was not an aunt of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.mother_two, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Mother Two was not an aunt of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.uncle_five, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Five was not an uncle of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.uncle_six, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Six was not an uncle of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.uncle_seven, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Seven was not an uncle of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(old_full_family.cousin_two, new_full_family.uncle_eight, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Uncle Eight was not an uncle of Cousin Two')
            ...
            # Cousin 9
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_nine, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Nine was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_nine, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Nine was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_nine, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Nine')

            # Cousin 10
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_ten, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Ten was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_ten, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Ten was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_ten, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Ten')

            # Cousin 11
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_eleven, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Eleven was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_eleven, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Eleven was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_eleven, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Eleven')

            # Cousin 12
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_twelve, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Twelve was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_twelve, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Twelve was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_twelve, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Twelve')

            # Cousin 13
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_thirteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Thirteen was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_thirteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Thirteen was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_thirteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Thirteen')

            # Cousin 14
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fourteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fourteen was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fourteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fourteen was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fourteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Fourteen')

            # Cousin 15
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fifteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fifteen was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fifteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Fifteen was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_fifteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Fifteen')

            # Cousin 16
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_sixteen, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Sixteen was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_sixteen, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Cousin Sixteen was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.cousin_sixteen, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Cousin Sixteen')
            ...
            # Step Child 1
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.step_child_one, old_full_family.cousin_one, CommonRelationshipBitId.FAMILY_COUSIN), 'Step Child One was not a cousin of Cousin One')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.step_child_one, old_full_family.cousin_two, CommonRelationshipBitId.FAMILY_COUSIN), 'Step Child One was not a cousin of Cousin Two')
            CommonAssertionUtils.is_true(CommonRelationshipUtils.has_relationship_bit_with_sim(new_full_family.step_child_one, sim_a_uncle, CommonRelationshipBitId.FAMILY_AUNT_UNCLE), 'Sim A was not an uncle to Step Child One')
