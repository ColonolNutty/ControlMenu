...
def _common_add_replace_water_interaction_with_clothes(event_data: S4CLZoneEarlyLoadEvent):
...
@CommonEventRegistry.handle_events(ModInfo.get_identity())
def _common_set_washtub_to_incomplete_state_upon_replace_water(event_data: S4CLInteractionRunEvent):
