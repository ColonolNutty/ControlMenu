...
class S4CMSpawnSimsAtTargetLocationInteraction(CommonImmediateSuperInteraction):
    """S4CMSpawnSimsAtTargetLocationInteraction(*_, **__)
    ...
    def get_log_identifier(cls) -> str:
        return 's4cm_spawn_sims_at_target_location'
    ...
    def on_started(self, interaction_sim: Sim, interaction_target: Any) -> bool:
        ...
        dialog = CommonPremadeChooseSimsOptionDialog(
            S4CMStringId.CHOOSE_SIMS_TO_SPAWN,
            0,
