...
class S4CMTeleportSimsToTargetLocationInteraction(CommonImmediateSuperInteraction):
    """S4CMTeleportSimsToTargetLocationInteraction(*_, **__)
    ...
    def get_log_identifier(cls) -> str:
        return 's4cm_teleport_sims_to_target_location'
    ...
    def on_started(self, interaction_sim: Sim, interaction_target: Any) -> bool:
        ...
        def _on_submit(chosen_sim_info_list: Tuple[SimInfo]) -> None:
            ...
            for chosen_sim_info in chosen_sim_info_list:
                ...
                try:
                    CommonSimSpawnUtils.hard_reset(chosen_sim_info, ResetReason.RESET_EXPECTED, source=interaction_sim, cause='S4CM: Teleporting Sim')
