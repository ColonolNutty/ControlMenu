...
class S4CMSetMaximumHouseholdSizeOp(S4CMSingleSimOperation):
    """Set the maximum household size."""

    # noinspection PyMissingOrEmptyDocstring
    @property
    def log_identifier(self) -> str:
        return 's4cm_set_maximum_household_size_speed'
    ...
    def run(self, sim_info: SimInfo, on_completed: Callable[[bool], None] = CommonFunctionUtils.noop) -> bool:
        ...
        CommonDialogInputIntegerOption(
            ...
            CommonDialogOptionContext(
                ...
                description_tokens=(
                    S4CMSimControlMenuStringId.SET_MAXIMUM_HOUSEHOLD_SIZE_DESCRIPTION,
