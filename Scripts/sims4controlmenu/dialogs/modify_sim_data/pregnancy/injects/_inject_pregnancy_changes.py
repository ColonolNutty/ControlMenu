...
def _cm_adjust_pregnancy_duration_on_pregnancy_start(original, self, *_, **__) -> Any:
    ...
    pregnancy_commodity.add_statistic_modifier(S4CMSettingUtils.get_pregnancy_speed_modifier())
...
def _cm_adjust_pregnancy_duration_on_pregnancy_end(original, self, *_, **__) -> Any:
    ...
    if tracker is not None:
        ...
        if stat is not None:
            stat.remove_statistic_modifier(S4CMSettingUtils.get_pregnancy_speed_modifier())
